...
class WarehouseController extends ApiController
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        if (method_exists(Warehouse::class, 'company')) {
        ...
        return $this->paginatedResponse($data, WarehouseResource::class);
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $record = Warehouse::create($validated);

        return $this->successResponse(
            new WarehouseResource($record),
    ...
    public function show(Request $request, string $id): JsonResponse
    {
        ...
        return $this->successResponse(new WarehouseResource($record));
    }
